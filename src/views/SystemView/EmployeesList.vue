        ...
        <table class="va-table va-table--hoverable full-width">
          ...
          <tbody>
            <tr v-for="employee in employees" :key="employee.empCode">
              ...
              <td>
                <va-select v-model="employee.selectedAuthorityCode" placeholder="권한 선택" :options="authorityCodeOptions"
                  @update:modelValue="authorityChange(employee)" />
              </td>
              <td>
                <VaButton @click="openAlarmSettingsModal(employee)">알림 설정</VaButton>
              </td>
            </tr>
          </tbody>
        </table>
