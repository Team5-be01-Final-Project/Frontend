...
- [Design] 5/4.1.0/SH 디자인 통일 및 일괄 적용
- [Deploy] release/5.0.0 5차 배포
- [Design] 5/4.1.0/SH 디자인 통일 및 일괄 적용 (간격)
- [Design] 5/5.1.0/SH 디자인 통일 및 일괄 적용 (정렬)
- [Design] 5/5.2.0/SH 디자인 통일 및 일괄 적용 (정렬2)
- [Fix] 5.2.1/5.1.1/WY 사원리스트 조회 리스트 수정
- [Fix] 5.8.1/5.1.1/WY 동일 거래처 및 상품은 합쳐지게 수정

2024-04-13
- [Fix] 5.7.1/5.1.0/SM 전표 매출액 합계 표시 오류 및 출력 방법 수정

2024-04-14
- [Add] 5.12.3/5.1.0.SH 인센티브 시뮬레이션 세부 기능 추가

2024-04-15
- [Design] 5.5.2/5.1.0/SH 거래처별 판매 상품 등록 버튼 디자인 변경
- [Design] 5.4/5.3.0/MS 디자인 변경
- [Design] 5.4/5.4.0/MS 디자인 수정
- [Design] 5.4.1/5.1.0/SH 사이드바 텍스트 통일
- [Add] 5.10.2/5.1.0/SH 거래처 조회 수정 밑줄, 담당사원 추가
- [Add] 5.5/5.1.0/SH 거래처 제품 등록 및 수정 '판매가 > 단가' 조건 추가
- [Fix] 5.0.0/5.1.0/MS 모달 수정
- [Fix] 5.10.1/5.1.1/WY 거래처 등록 시 전직원이 아닌 영업사원만 표시되게 수정
- [Fix] 5.0.0/5.2.0/MS 버튼 통일
- [Fix] 5.10.3/5.1.1/WY 거래처 수정 시 전직원이 아닌 영업사원만 표시되게 수정
- [Add] 5.7.2/5.1.1/WY 비고란 추가
- [Fix] 5.2.2/5.1.0/SM 알림 설정 모달에서 코드명에서 이름으로 표시 변경
- [Design] 5.4.1/5.1.0/SH 상품 -> 제품 사이드바 텍스트 통일
- [Feat]  5.0.0/5.3.0/MS 엑셀로 추출

2024-04-16
- [Add] 5.4.1/5.1.0/MS 창고 차량 온도에 시스템 온도 추가하기
- [Fix] 5.2.1/5.1.2/SM BE 변경에 따른 헤더 변경 
- [Fix] 5.5.2/5.1.1/SM 모달창 에러메시지 노출 오류 관련 변경
- [Fix] 5.10.1/5.1.2./WY 거래처 등록 시 계약 날짜 버그 수정
- [Fix] 5.6.2/5.1.1/WY 재고등록 제품명 셀렉트 방식으로 수정
- [Fix] 5.7.2/5.1.2/SM 조회 조건(결재상태) 별도 추가
- [Fix] 5.7.1/5.1.1/SM 조회 조건(결재상태) 별도 추가
- [Add] 5.5.3/5.1.0/MS 전표 리스트 조회 정렬 기능 추가
- [Fix] 5.2.2/5.1.1/WY 모달창 간격 조정 및 알림창 추가
- [Fix] 5.4.2/5.3.0/SM 새로 고침 버튼 디바운싱 적용
- [Fix] 5.12.2/5.1.0/SH 내 매출현황 버그 수정
- [Fix] 5.12.3/5.2.0/SH 인센티브 시뮬레이션 매출과 순위 버그 수정
- [Fix] 5.12.3/5.2.1/SH 인센티브 시뮬레이션 매출과 순위 버그 수정 2
- [Deploy] release/6.0.0 6차 배포

2024-04-17
- [Fix] 5.0.0/6.1.0/WY 전체 폰트 수정
- [Fix] 5.7.1/6.1.0/SM 전표 검색 필터 오작동 수정
- [Fix] 5.7.2/6.1.0/SM 전표 상태 필터링 오작동 수정
- [Fix] 5.10.2/6.1.0/SM 거래처조회 사원은 삭제 컬럼이 아예 안보이도록 수정
- [Fix] 5.10.0/6.1.0/SM 사이드바에서 거래처 조회를 제일 위로 위치
- [Fix] 5.0.0/6.1.1/WY 로그아웃 크기 조정
- [Fix] 5.12.3/6.1.0/SM 인센티브 시뮬레이션 디테일 수정
- [Fix] 5.8.1/6.1.0/SM 월 선택 박스 초기값 오류 수정
- [Fix] 5.8.1/6.2.0/SM 정렬 표시 수정
- [Fix] 5.4/6.1.0/WY 404페이지 네비게이션바 감추기
- [Fix] 5.0.0/6.2.0/SM 검색 조건 미선택시 검색 어 입력 비활성화
- [Fix] 5.2.3/6.1.0/WY 화면 별 권한 관리 수정
- [Fix] 5.6.1/6.1.0/SH 재고 조회 권한 관리 수정

2024-04-19
- [Design] 5.0.0/6.1.0/SH 대시보드와 모달 디자인 수정 1
- [Fix] 5.0.0/6.1.1/WY 디자인 수정 및 인센티브 수식 변경
- [Fix] 5.10.3/6.1.1/WY 거래처 수정 표시값 수정
- [Fix] 5.6.1/6.1.1/WY 재고조회 화면 권한 수정
- [Fix] 5.5.1/6.1.1/WY 화면 권한 수정
- [Deploy] release/7.0.0 7차 배포